...
echo "[5/9] Configuring lightdm auto-login for $(whoami)…"
...
echo "[6/9] Configuring Openbox as default session manager…"
sudo update-alternatives --set x-session-manager /usr/bin/openbox-session


# ── systemd service: serial bridge ────────────────────────────────────────────
echo "[7/9] Installing wmi-bridge systemd service…"
...
echo "[8/9] Installing wmi-kiosk systemd service…"
...
echo "[9/9] Adding $(whoami) to dialout group (serial port access)…"
